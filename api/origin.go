...
type Origin interface {
	/**
	 * When running a pipeline, the Data Extractor calls this method from the <code>Origin</code> stage to obtain
	 * a batch of records for processing.
	 * <p/>
	 * <code>Origin</code> stages should not block indefinitely within this method if there is no data. They should
	 ...
	 *
	 * @param lastSourceOffset the offset returned by the previous call to this method, or <code>NULL</code> if
	 ...
	 * @param batchMaker records created by the <code>Source</code> stage must be added to the
	 * <code>BatchMaker</code> for them to be available to the rest of the pipeline.
